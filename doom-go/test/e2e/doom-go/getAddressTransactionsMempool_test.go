...
func TestGetAddressTransactionsMempool(t *testing.T) {
	reqData := struct {
	...
	resp, err := postJsonRequest(_kongDNS+"/doom/bitcoin/getAddressTransactionsMempool/v1", &reqData, nil, &respData, nil)
	if err != nil {
		t.Error(err)
		return
	}
