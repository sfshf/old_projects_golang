...
var (
	...
	Uint256E27    = new(uint256.Int).Exp(uint256.NewInt(10), uint256.NewInt(27))
...
func Float64ToFloat64(src float64, decimals uint8) float64 {
	bigSrc := big.NewFloat(src)
	ten := big.NewFloat(10)
	for ; decimals > 0; decimals-- {
		bigSrc = bigSrc.Quo(bigSrc, ten)
	}
	res, _ := bigSrc.Float64()
	return res
}
