...
import (
	...
	grpcserver "github.com/nextsurfer/pswds_backend/internal/server"
...
type Application struct {
	...
	PswdsServer         *grpcserver.PswdsServer
...
func (app *Application) RegisterServers(ctx context.Context) error {
	// register servers
	pswdsServer, err := grpcserver.NewPswdsServer(
		ctx,
		app.Env,
		app.Name,
		app.Logger,
	...
	pswds_api.RegisterPasswordServiceServer(
		app.Server.GrpcServer(),
		pswdsServer)
	app.PswdsServer = pswdsServer
