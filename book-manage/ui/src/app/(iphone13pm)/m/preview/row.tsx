        ...
        {(translID > 0 || writingTransl) && (
          ...
          >
            ...
            <Select
              ...
              defaultValue={
                translIndex > -1 ? translations[translIndex].language_code : ''
              }
              value={languageCode}
...
export const FieldRow = ({
  ...
  const twoLine = (field: string): boolean => {
    switch (field) {
      case 'string':
        return true;
      case 'definition':
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // console.log(respData.data.path)
      ...
      <Stack direction="row" spacing={2} alignItems="center">
        ...
        {twoLine(field) && (
          ...
          >
            ...
            <Button
              ...
              color="warning"
              sx={
                !read_only && (disableDeletes(field) || !prevTxt)
                  ? {
                      width: '50px',
                      height: '25px',
                      display: 'none',
        ...
        {!twoLine(field) && (
          <>
            ...
            >
              {!isExample(field) && field != 'definition_operatelog' && (
                <Typography
                  variant="body1"
                  ...
                  {prevTxt.split('').map((item, index) => {
                    for (let j = 0; j < prevPositionIndexs.length; j += 2) {
                      if (
                        ...
                        index <
                          prevPositionIndexs[j] + prevPositionIndexs[j + 1]
                      ) {
                        return (
                          <span
                            key={index}
        ...
        <DialogContent>
          ...
          {isExample(field) && (
            ...
            >
              ...
              <Typography
                variant="body1"
                sx={{ whiteSpace: 'pre-wrap', paddingLeft: '20px' }}
                gutterBottom
                fontSize={13}
              >
                {prevTxt.split('').map((item, index) => {
