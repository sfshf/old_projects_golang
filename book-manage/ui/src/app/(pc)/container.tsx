...
const LINKS = [
  ...
  { text: 'Add', href: '/add' },
  { text: 'New Definition', href: '/new-definition' },
  { text: 'Definition List', href: '/list-definition' },
  { text: 'Preview', href: '/preview' },
  { text: 'Search', href: '/search' },
  { text: 'OperateLog', href: '/operate-log' },
  { text: 'WorkingEthics', href: '/working-ethics' },
