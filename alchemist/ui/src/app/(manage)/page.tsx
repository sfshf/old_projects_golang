...
export default function Home() {
  ...
  const listAppConfigs = async () => {
    ...
    post('/alchemist/console/listConfigs/v1', reqData, (respData) => {
  ...
  const createAppConfig = async () => {
    ...
    post('/alchemist/console/createConfig/v1', reqData);
  };
  ...
  const updateAppConfig = async () => {
    ...
    post('/alchemist/console/updateConfig/v1', reqData);
  };
  ...
  const deleteAppConfig = async () => {
    ...
    post('/alchemist/console/deleteConfig/v1', reqData);
  };
  ...
  const configExample = `{
  "appID":"alchemist.test",
  "productId":"alchemist.test",
  "deviceCheck": {
        ...
        {isDelete && (
          <DialogContent>
            <Typography variant="h6" gutterBottom>
              Are you sure to delete record {configID} ?
            </Typography>
          </DialogContent>
        )}
        <DialogActions>
