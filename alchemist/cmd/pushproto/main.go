...
var services = []ServiceConfig{
	{
		...
		Url:           "",
		PathPrefix:    "/alchemist",
		ProtoFilePath: "api/http/alchemist.http.proto",
	},
	{
		Name:          "alchemist-notification",
		Application:   "alchemist",
		Url:           "",
		PathPrefix:    "/alchemist/appstore",
		ProtoFilePath: "api/http/alchemist_notification.http.proto",
	},
}
