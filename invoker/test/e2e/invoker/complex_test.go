...
func TestI18nEnglish(t *testing.T) {
	...
	// send request
	resp, err := postJsonRequest(_kongDNS+"/invoker/site/getSite/v1", &reqData, nil, &respData, nil)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestI18nChinese(t *testing.T) {
	...
	// send request
	resp, err := postJsonRequest(_kongDNS+"/invoker/site/getSite/v1", &reqData, nil, &respData, func(req *http.Request) {
