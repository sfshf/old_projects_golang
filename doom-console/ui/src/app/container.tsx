...
const LINKS = [
  { text: 'Reputable Tokens', href: '/reputable-tokens' },
  { text: 'Error Tokens', href: '/error-tokens' },
  { text: 'Uniswap Info', href: '/uniswap-info' },
  { text: 'ERC20 Tokens Info', href: '/erc20-tokens-info' },
  { text: 'ERC20 Tokens Query', href: '/erc20-tokens-query' },
  { text: 'RPC Server', href: '/rpc-server' },
];
...
function Container({ children }: { children: React.ReactNode }) {
  ...
  React.useEffect(() => {
    if (window.innerWidth <= 600) {
      router.push('/m' + pathName + '?' + params, { scroll: false });
    }
