...
import (
	...
	"github.com/nextsurfer/doom-console/internal/app/grpc"
)
...
func main() {
	...
	if kongAddress == "" {
		log.Fatalf("must set env variable for 'KONG_ADDRESS'")
	}
	...
	app, err := grpc.NewApplication(ctx, appName, kongAddress, grpcPort, appHost, appEnv, tomlPath, mongodbUri)
	if err != nil {
