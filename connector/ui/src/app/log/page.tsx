...
const columns: readonly Column[] = [
  ...
  { id: 'apiKeyName', label: 'ApiKeyName', minWidth: 100 },
  { id: 'operation', label: 'Operation', minWidth: 100 },
  { id: 'object', label: 'Object', minWidth: 100 },
...
export default function Home() {
  ...
  const getManagePlatformLogs = async () => {
    const reqData = {
      apiKey: shared.getPassword(),
      pageSize: pageSize,
      pageNumber: pageNumber,
    };
    post('/riki/console/getManagePlatformLogs/v1', reqData, (respData) => {
