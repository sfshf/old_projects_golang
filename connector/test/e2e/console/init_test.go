...
var (
	...
	_adminApiKey = os.Getenv("RIKI_ADMIN_APIKEY")   // admin
	_test2ApiKey = os.Getenv("PSWD_RIKI_E2E_TEST1") // pswd_riki-e2e-test1 write
	_test3ApiKey = os.Getenv("PSWD_RIKI_E2E_TEST2") // pswd_riki-e2e-test2 read
)
