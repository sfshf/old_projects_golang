...
// 		log.NewTraceIDContext(
// 			log.NewTagContext(ctx, "__test__"),
// 			"traceID_test",
// 		),
// 		"userID_test",
// 	)
...
// 	ctx := log.NewTagContext(
// 		log.NewUserIDContext(
// 			log.NewTraceIDContext(context.TODO(), "traceID_foo"),
// 			"userID_foo",
// 		),
// 		"tag_foo",
// 	)
// 	l := log.NewLogger(ioutil.Discard)
// 	l.SetVersion("v0.0.0")
// 	b.ResetTimer()
