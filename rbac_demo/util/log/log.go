...
// NewLogger SetWriters set the writers of the logger.
...
// SetTimeFieldLocation Set time field location.
...
// SetTimeFieldName Set time field name.
func (a *Logger) SetTimeFieldName(name string) {
	zerolog.TimestampFieldName = name
}

// SetTimeFieldFormat Set time field format.
...
// WriteLevel To implement zerolog.LevelWriter.
