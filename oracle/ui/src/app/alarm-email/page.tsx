...
export default function Home() {
  ...
  const listAlarmEmails = async () => {
    const reqData = {
      apiKey: shared.getPassword(),
    };
    post('/console/listAlarmEmails/v1', reqData, (respData) => {
      setList(respData.data.list);
    });
  };

  const addAlarmEmail = async () => {
    const reqData = {
      apiKey: shared.getPassword(),
      address: address,
    };
    post('/console/addAlarmEmail/v1', reqData, (respData) => {});
  };

  const deleteAlarmEmail = async () => {
    const reqData = {
      apiKey: shared.getPassword(),
      id: id,
    };
    post('/console/deleteAlarmEmail/v1', reqData, (respData) => {});
  };

  const updateAlarmEmail = async () => {
    const reqData = {
      apiKey: shared.getPassword(),
      id: id,
      address: address,
    };
    post('/console/updateAlarmEmail/v1', reqData, (respData) => {});
  };
